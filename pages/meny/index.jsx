...
// components
import MenuHeaders from "@/components/meny/menuHeaders";
// icons
import ImgMenu from "@/public/assets/images/menu/menu.png";

const Meny = ({ foodList, categorys }) => {
  ...
  return (
    <>
      <Head>
        <title>Meny | Twins Pizzeria & Pub</title>
      </Head>
          ...
          {categorys
            ?.filter((itm) => {
              if (select == "") {
                ...
                itm.title.toLowerCase().includes(select.toLowerCase())
              ) {
                return itm;
              }
            })
                        ...
                        return (
                          ...
                          >
                            <div className="flex sm:max-w-5xl max-w-[200px] items-center justify-start gap-4 py-2">
                              <p className="text-base text-blue28">
                                {index + 1}
                              </p>
